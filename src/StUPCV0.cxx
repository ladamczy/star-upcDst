...
// _________________________________________________________
StUPCV0::StUPCV0(StMuTrack const * const particle1, StMuTrack const * const particle2,
...
*/
  ...
  TVector3 origin1(0.0,0.0,0.0);
  origin1.SetX(particle1->helix().origin().x());
  origin1.SetY(particle1->helix().origin().y());
  origin1.SetZ(particle1->helix().origin().z());
 
  StPicoPhysicalHelix p1Helix = StPicoPhysicalHelix (particle1->helix().curvature(), 
                                                     particle1->helix().dipAngle(), 
                                                     particle1->helix().phase(), 
                                                     origin1,
                                                     particle1->charge() );


  TVector3 origin2(0.0,0.0,0.0);
  origin2.SetX(particle2->helix().origin().x());
  origin2.SetY(particle2->helix().origin().y());
  origin2.SetZ(particle2->helix().origin().z());
 


  StPicoPhysicalHelix p2Helix =	StPicoPhysicalHelix (particle2->helix().curvature(), 
                                                     particle2->helix().dipAngle(), 
                                                     particle2->helix().phase(), 
                                                     origin2,
                                                     particle2->charge() );
